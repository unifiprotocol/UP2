...
// contract AAVEHarmonyTest is AccessControl, Pausable, Safe {
...
//     rewardsBalance = IRewardsController(aaveIncentivesController).getUserRewards(asset, address(this), wrappedTokenAddress);
